# Swing Fibonacci Mapper

Automatically detects major swing points using scipy signal processing and draws Fibonacci retracement and extension levels. This support and resistance indicator provides quantitative signals that can be applied to any liquid market across all timeframes.
...
Core techniques include exponential moving average, simple moving average, high-low range analysis. The computation processes all bars simultaneously using vectorized numpy operations, ensuring consistent results regardless of the dataset size.
...
|-----------|---------|-------|-------------|
| Swing Order | 15 | 5 - 40 | Controls swing order sensitivity (int) |
