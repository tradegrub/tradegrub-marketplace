# Annual Range Reference

Tracks and displays rolling 252-bar annual high, low, and open reference levels with distance percentage using numpy. This support and resistance indicator provides quantitative signals that can be applied to any liquid market across all timeframes.
...
|-----------|---------|-------|-------------|
| Annual Period | 252 | 100 - 300 | Controls annual period sensitivity (int) |

## Signals

- **Annual High**: Primary visual output plotted as a continuous line on the chart
- **Annual Low**: Primary visual output plotted as a continuous line on the chart
- **Annual Open**: Primary visual output plotted as a continuous line on the chart
- **Annual Mid**: Primary visual output plotted as a continuous line on the chart
