...
The fractal dimension calculation requires nested loops, log-log regression, and dynamic array construction that cannot be expressed in Pine:
...
This multi-scale analysis with arbitrary subsampling, dynamic array sizes, and least-squares fitting is impossible in Pine, which lacks array indexing with computed strides, regression functions on arbitrary data, and nested iteration.
