...
Pine cannot natively cast boolean arrays to integers and sum them in a vectorized operation. In Python with NumPy, the consensus scoring is a single vectorized expression across the entire dataset:
