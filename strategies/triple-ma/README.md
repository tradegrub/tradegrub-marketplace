...
Price
 ...
 +──────────────────────────────────── Time
       Mid < Slow:        Mid > Slow:
       NO ENTRY            🟢 BUY
       (filter blocks)    (fast x mid + trend OK)
                                  🔴 EXIT
                              (fast x under mid)
```
