...
Price
 ...
 │      ══════════════════════
 └──────────────────────────────── Time
    Strong Uptrend  Squeeze  Reversal / New Trend
```
...
In Python, you could generate N EMAs from any list using a list comprehension and programmatically loop over fill pairs. Pine Script has no array of plot references and requires each plot and fill call to be hardcoded, making dynamic ribbon construction impossible.
