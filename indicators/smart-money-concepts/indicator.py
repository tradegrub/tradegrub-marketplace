...
if show_bos:
    ...
    plotshape(bos_up, "BOS Up", shape="triangleup", location="abovebar", color="green", size="small")
    plotshape(bos_down, "BOS Down", shape="triangledown", location="belowbar", color="red", size="small")
