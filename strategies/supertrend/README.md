...
Price
 ...
 |  /   ╱╱ \
 | / ╱╱╱    \     Supertrend line
 |╱╱╱         \   (flips on direction change)
 |╱             \    ╲╲╲
 |               \  ╱╱  ╲╲╲
 |                ╲╱       ╲╲╲
 +──────────────────────────────── Time
       UPTREND     BUY    EXIT
    (line below)  (flip)  (flip)
```
