# Quarterly Range Reference

Tracks and displays rolling 63-bar quarterly high, low, and open reference levels with breakout detection using numpy. This support and resistance indicator provides quantitative signals that can be applied to any liquid market across all timeframes.
...
|-----------|---------|-------|-------------|
| Quarterly Period | 63 | 40 - 80 | Controls quarterly period sensitivity (int) |

## Signals

- **Quarterly High**: Primary visual output plotted as a continuous line on the chart
- **Quarterly Low**: Primary visual output plotted as a continuous line on the chart
- **Quarterly Open**: Primary visual output plotted as a continuous line on the chart
- **New High**: Discrete signal marker displayed at key points
- **New Low**: Discrete signal marker displayed at key points
